...
const matchesApiKey = "b8eecc5500msh050a388caa94177p197c68jsn06ca21996daf";
...
$("#filter-btn").on("click", (e) => {
  ...
  const from = $(".filters #dateFrom").val() || `${season}-08-11`;
  const to = $(".filters #dateTo").val() || `${season}-08-21`;
