...
function renderMatches(matches) {
  for (i = 0; i < matches.length; i++) {
    let match = {
      teamOne: matches[i].teams.home.name,
      teamOneLogo: matches[i].home.logo,
      teamOneScore: matches[i].goals.home,
      teamTwo: matches[i].teams.away.logo,
      teamTwoLogo: matches[i].away.logo,
      teamTwoScore: matches[i].goals.away,
      data: matches[i].fixture.date,
    };
    const matchCard = `
            ...
            <div class="match-card border rounded p-3 shadow-sm">
              ...
              <div class="row align-items-center">
                ...
                <div class="col-4 d-flex flex-column align-items-center">
                  <span class="fs-3">${match.teamOneLogo}</span>
                ...
                <!-- الفريق الثاني -->
                <div class="col-4 d-flex flex-column align-items-center">
                  <span class="fs-3">${match.teamTwoLogo}</span>
