...
async function getAllTeams(season = "2023/2024") {
  fetch(
    `https://apiv2.allsportsapi.com/football/?met=Teams&leagueId=${leagueId}&APIkey=${APIKey}&league_season=${season}`,
    {
      method: "GET",
    }
  )
