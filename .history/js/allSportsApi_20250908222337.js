...
let Url = `https://apiv2.allsportsapi.com/football/?met=Fixtures&leagueId=${leagueId}&page=${page}&per_page=${limit}&APIkey=${APIKey}&timezone=Africa/Cairo${
...
async function getAllTeams() {
  fetch(
    `https://apiv2.allsportsapi.com/football/?met=Teams&leagueId=${leagueId}&APIkey=${APIKey}&season=${
...
//         ${match.matchStatus === "Finished" ? "text-danger" : ""}
//         ${match.matchStatus === "Not Started" ? "text-primary" : ""}
//         ${match.matchStatus === "Live" ? "text-success" : ""}">
//         ${
...
//       <!-- تاريخ المباراة -->
//       <p class="match-date mt-3 text-muted small">${match.date}</p>
// </div>
