   ...
   <div class="col-lg-4 col-md-6 mb-4">
            <div class="match-card border rounded p-3 shadow-sm">
              ...
              <div class="row align-items-center">
                ...
                <div class="col-4 d-flex flex-column align-items-center">
                ${
                  match.finalResult && match.matchStatus === "Finished" ? (
                    <div>
                      <span class="fs-4 fw-bold">"انتهت"</span>{" "}
                ...
                ${
                  match.finalResult === "-" ? (
                    <div>
                      <span class="fs-4 fw-bold">"قادمة"</span>{" "}
                      <span class="text-muted small">لم تبدأ</span>
                    </div>
                  ) : (
                    ""
                  )
                ...
                ${
                  match.finalResult && match.matchStatus === "Live" ? (
                    <div>
                      <span class="fs-4 fw-bold">"مباشر"</span>{" "}
                      <span class="text-muted small">النتيجة</span>
                    </div>
                  ) : (
                    ""
                  )
