...
let filterData = { season: 2025, from: "2025-08-11", to: "2025-08-21" };
let searchParams = getSearchParams(filterData);

let Url = `https://apiv2.allsportsapi.com/football/?met=Fixtures&leagueId=39&APIkey=${APIKey}&timezone=Africa/Cairo${
...
async function getAllTeams() {
  fetch(
    `https://apiv2.allsportsapi.com/football/?met=Teams&leagueId=39&APIkey=${APIKey}&seasonId=${
